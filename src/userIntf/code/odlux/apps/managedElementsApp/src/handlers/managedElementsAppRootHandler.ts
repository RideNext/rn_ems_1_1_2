...
import { IConnectedNetworkElementsState, testconnectedNetworkElementsActionHandler } from './connectedNetworkElementsHandler';
...
interface IManagedElementsAppStoreState {
...
declare module '../../../../framework/src/store/applicationStore' {
  interface IApplicationStoreState {
    managedelements: IManagedElementsAppStoreState;
  }
}

const actionHandlers = {
  connectedNetworkElements: testconnectedNetworkElementsActionHandler,
  deviceDescription: deviceDescriptionHandler,
  viewDescription: viewDescriptionHandler,
  valueSelector: valueSelectorHandler,
};

export const managedElementsAppRootHandler = combineActionHandler<IManagedElementsAppStoreState>(actionHandlers);
export default managedElementsAppRootHandler;
