...
class ConnectionStatusLogComponent extends React.Component<ConnectionStatusLogComponentProps, ConnectionStatusLogComponentState > {
  ...
  render(): JSX.Element {
    ...
    return (
    <>
      <ConnectionStatusTable stickyHeader title={"Connection Status"} tableId="connection-status-table" customActionButtons={[refreshConnectionStatusLogAction]}  columns={[
