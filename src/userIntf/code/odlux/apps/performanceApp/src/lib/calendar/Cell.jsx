...
class Cell extends React.Component {
  ...
  styleCellNonMouseEnter() {
    ...
    // If the cell day matches the selected date, apply a special style
    if (cellDay.isSame(date, 'day')) {
        this.setState({ style: startDateStyle() });
    } 
    // Otherwise, apply the normal cell style
    else {
