...
interface IPerformanceAppStoreState {
...
declare module '../../../../framework/src/store/applicationStore' {
  interface IApplicationStoreState {
    performance: IPerformanceAppStoreState;
  }
}
...
export const performanceAppRootHandler = combineActionHandler<IPerformanceAppStoreState>(actionHandlers);
export default performanceAppRootHandler;
