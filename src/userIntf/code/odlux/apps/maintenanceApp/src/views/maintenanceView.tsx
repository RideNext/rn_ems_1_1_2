              ...
              <DialogContent>
                <Card style={{overflowX:'auto'}}>
                  ...
                  <div>
                    ...
                    <div>
                      <strong>Notifications:</strong> {this.state.elsdata.rowData.notifications}
                    </div>
                    <div>
                      <strong>Active:</strong> {this.state.elsdata.rowData.active ? 'Active' : 'Not Active'}
                    </div>

                    <div>
                      <strong>Start:</strong> {this.state.elsdata.rowData.start}
                    </div>
                    <div>
                      <strong>End:</strong> {this.state.elsdata.rowData.end}
                    </div>
