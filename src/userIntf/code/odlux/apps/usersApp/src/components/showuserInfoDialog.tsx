...
import { userConfigResponse } from '../models/userServer';
import { Panel } from '../../../../framework/src/components/material-ui/panel';

export enum userInfoDialogMode {
    None = "none",
    ShowDetails = "showDetails"
}

const mapProps = (state: IApplicationStoreState) => ({ supportedDevices: state.users.userServerState.supportedDevices })

type ShowuserInfoDialogComponentProps = Connect<typeof mapProps, undefined> &
{
...
type ShowuserInfoDialogComponentState = {
    status: string,
    devicetype: string,
...
/*
Displays all values of a user server 
*/
class ShowuserInfoDialogComponent extends React.Component<ShowuserInfoDialogComponentProps, ShowuserInfoDialogComponentState> {

    constructor(props: ShowuserInfoDialogComponentProps) {
        super(props);
    ...
    render() {
        return (
            <Dialog open={this.props.mode !== userInfoDialogMode.None} onBackdropClick={this.props.onClose} >
...
export const ShowuserInfoDialog = connect(mapProps)(ShowuserInfoDialogComponent)
