      ...
      <div className={classes.root}>
        {this.props.busy || this.state.busy
          ...
          this.props.isReachable ?
            ...
            <MediatorServerConfigurationsTable  tableId={null}  stickyHeader title={this.props.serverName || ''} customActionButtons={[addMediatorConfigAction]} idProperty={"Name"} rows={this.props.configurations} asynchronus columns={[
