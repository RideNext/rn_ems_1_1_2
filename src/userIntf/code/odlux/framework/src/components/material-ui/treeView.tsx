...
class TreeViewComponent extends React.Component<TreeViewComponentProps<any>, TreeViewComponentState<any>> {

  /**
    * Initializes a new instance.
    */
  constructor(props: TreeViewComponentProps<any>) {
    super(props);
  ...
  private renderItems = (items: TreeItem<any>[], searchTerm: string | undefined, depth: number = 1, forceRender: boolean = true) => {
  ...
  private renderItem = (item: ExternalTreeItem<any> , searchTerm: string | undefined, depth: number, isFolder: boolean, expanded: boolean, forceRender: boolean): JSX.Element | null => {  
    const styles = {
      item: {
  ...
  private onFolderClick = (item: TreeItem<any>) => {
  ...
  private onItemClick = (item: TreeItem<any>) => {
