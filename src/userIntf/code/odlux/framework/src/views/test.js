...
var withComponents_1 = require("../utilities/withComponents");
...
var material_table_1 = require("../components/material-table");
var treeView_1 = require("../components/material-ui/treeView");
var styles = function (theme) { return createStyles_1["default"]({
    root: {
        width: '100%'
    },
    heading: {
...
var SampleDataMaterialTable = material_table_1.MaterialTable;
var SampleTree = treeView_1.TreeView;
var TestComponent = function (props) {
    return (<div>
      <h2>About</h2>
      <Accordion_1["default"]>
        <AccordionSummary_1["default"] expandIcon={<ExpandMore_1["default"] />}>
          <Typography_1["default"] className={props.classes.heading}>Client Side Table Demo</Typography_1["default"]>
        </AccordionSummary_1["default"]>
        <AccordionDetails_1["default"]>
          <SampleDataMaterialTable rows={tableData} tableId={null} columns={[
        { property: "index", type: material_table_1.ColumnType.text, title: "Index", width: "80px", disableFilter: true, disableSorting: true },
        { property: "firstName", type: material_table_1.ColumnType.text, title: "First Name" },
        { property: "lastName", type: material_table_1.ColumnType.text, title: "Last Name" },
        { property: "age", type: material_table_1.ColumnType.numeric, title: "Age", width: "60px" },
        { property: "email", type: material_table_1.ColumnType.text, title: "eMail" },
        { property: "actions", type: material_table_1.ColumnType.custom, title: "Actions", customControl: function (_a) {
      ...
      <Accordion_1["default"]>
        <AccordionSummary_1["default"] expandIcon={<ExpandMore_1["default"] />}>
          <Typography_1["default"] className={props.classes.heading}>Tree Demo</Typography_1["default"]>
        </AccordionSummary_1["default"]>
        <AccordionDetails_1["default"]>
...
exports.Test = withComponents_1.withComponents(components)(withStyles_1["default"](styles)(TestComponent));
