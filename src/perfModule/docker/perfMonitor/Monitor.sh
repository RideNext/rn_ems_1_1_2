...
#do
   ...
   do
      ...
      case $nameDock in
	  "kafka" | "identity" | "zookeeper" | "identitydb" | "mysql" | "perf-monitor" | "ves-collector" | "sdnr" | "sdnc-web" | "ntsim-ng-topology-server" | "nbi" | "dfc" | "onap-dmaap" | "persistence")
                      echo   "$i"
                      echo " "
