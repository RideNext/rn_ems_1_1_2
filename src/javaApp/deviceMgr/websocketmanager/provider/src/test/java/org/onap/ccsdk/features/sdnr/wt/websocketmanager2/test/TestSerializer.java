...
public class TestSerializer {
    ...
    public void test1() {
        ...
        NotificationOutput output = new NotificationOutput(notification, NODEID, ObjectCreationNotification.QNAME,Instant.parse(DateAndTime.getDefaultInstance(TIMESTAMP).getValue()).toEpochMilli()*1000);
        String sOutput=null;
        try {
