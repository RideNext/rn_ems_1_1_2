...
public class WebSocketManagerProvider implements WebsocketManagerService, AutoCloseable {
    ...
    public void sendNotification(Notification notification, NodeId nodeId, QName eventType) {
        ...
        this.sendNotification(notification, nodeId, eventType,
                Instant.parse(YangToolsMapperHelper.getTime(notification, Instant.now()).getValue()).toEpochMilli()*1000);
    }

    @Override
    public void sendNotification(Notification notification, NodeId nodeId, QName eventType, Long eventTime) {
    ...
    @Override
    public void sendNotification(DOMNotification notification, NodeId nodeId, QName eventType, Long eventTime) {
