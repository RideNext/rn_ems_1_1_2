...
public interface WebsocketManagerService {
     ...
     * @param eventTime
     */
    void sendNotification(Notification notification, NodeId nodeId, QName eventType, Long eventTime);
     ...
     * @param eventTime
     */
    void sendNotification(DOMNotification notification, NodeId nodeId, QName eventType, Long eventTime);
