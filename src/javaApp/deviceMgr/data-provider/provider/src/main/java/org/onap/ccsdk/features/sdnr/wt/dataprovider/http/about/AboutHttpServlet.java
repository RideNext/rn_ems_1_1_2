...
public class AboutHttpServlet extends HttpServlet {
    ...
    private static final String PLACEHOLDER_SDNR = "{sdnr-version}";
    private static final String PLACEHOLDER_WEB = "{web-version}";
    private static final String PLACEHOLDER_VES = "{ves-version}";
    private static final String PLACEHOLDER_PERF = "{perf-version}";
    private static final String PLACEHOLDER_NBI = "{nbi-version}";
    private static final String PLACEHOLDER_ES = "{es-version}"; 
    private static final String PLACEHOLDER_KAFKA = "{kafka-version}";
    private static final String PLACEHOLDER_ZOO = "{zoo-keeper-version}";
    private static final String PLACEHOLDER_PANDA = "{red-panda-version}";
    private static final String PLACEHOLDER_IDB = "{identity-version}";
    private static final String PLACEHOLDER_IDENTITY = "{identity}";
    private static final String PLACEHOLDER_SQL = "{sql-version}";
    private static final String PLACEHOLDER_DFC = "{dfc-version}";
    ...
    private void collectStaticData() {
        ...
        this.data.put(PLACEHOLDER_ONAP_RELEASEVERSION, System.getenv("CURRENT_EMS_VERSION"));
        ...
        this.data.put(PLACEHOLDER_SDNR, System.getenv("SDNR_VERSION"));
        this.data.put(PLACEHOLDER_WEB, System.getenv("SDNCWEB_VERSION"));
        this.data.put(PLACEHOLDER_VES, System.getenv("VES_VERSION"));
        this.data.put(PLACEHOLDER_PERF, System.getenv("PERF_VERSION"));
        this.data.put(PLACEHOLDER_NBI, System.getenv("NBI_VERSION"));
        this.data.put(PLACEHOLDER_ES, System.getenv("PERSISTENCE_IMAGE"));
        this.data.put(PLACEHOLDER_KAFKA, System.getenv("KAFKA_IMAGE"));
        this.data.put(PLACEHOLDER_ZOO, System.getenv("ZOOKEEPER_IMAGE"));
        this.data.put(PLACEHOLDER_PANDA, System.getenv("REDPANDA_IMAGE"));
        this.data.put(PLACEHOLDER_IDB, System.getenv("IDENTITY_DB_IMAGE"));
        this.data.put(PLACEHOLDER_IDENTITY, System.getenv("IDENTITY_IMAGE"));
        this.data.put(PLACEHOLDER_DFC, System.getenv("DFC_IMAGE"));
        this.data.put(PLACEHOLDER_DATE, String.valueOf(LocalDate.now().getYear()));   
    }
