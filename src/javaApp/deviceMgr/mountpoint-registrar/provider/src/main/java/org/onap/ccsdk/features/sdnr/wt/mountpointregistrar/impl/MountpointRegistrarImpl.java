...
public class MountpointRegistrarImpl implements AutoCloseable, IConfigChangedListener {
    ...
    public void init() {
        ...
        FileReadyConfig filereadyConfig = new FileReadyConfig(configFileRepresentation);
        StateChangeConfig stateChangeConfig = new StateChangeConfig(configFileRepresentation);
        HeartBeatConfig heartBeatConfig = new HeartBeatConfig(configFileRepresentation);
        NotificationConfig notifcationConfig = new NotificationConfig(configFileRepresentation);
        ...
        configMap.put("fileready", filereadyConfig);
        configMap.put("stateChange", stateChangeConfig);
        configMap.put("notification", notifcationConfig);
