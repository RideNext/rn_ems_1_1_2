...
public class FileReadyConfig extends MessageConfig {

	private static final String SECTION_MARKER = "fileready";
        //private static final String DEFAULT_VALUE_CONSUMER_TOPIC = "unauthenticated.VES_NOTIFICATION_OUTPUT";
        private static final String DEFAULT_VALUE_CONSUMER_TOPIC = "";
    
	public FileReadyConfig(ConfigurationFileRepresentation configuration) {
		super(configuration);
