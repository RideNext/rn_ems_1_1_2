...
public class KeycloakProviderService extends AuthService {
    ...
    protected String getTokenVerifierUri() {
        return String.format("/realms/%s/protocol/openid-connect/token", urlEncode(this.config.getRealmName()));
    }

    @Override
    protected String getLoginUrl(String callbackUrl) {
        return String.format(
                "%s/realms/%s/protocol/openid-connect/auth?client_id=%s&response_type=code&scope=%s&redirect_uri=%s",
    ...
    protected String getLogoutUrl() {
        return String.format("%s/realms/%s/protocol/openid-connect/logout", this.config.getUrl(),
