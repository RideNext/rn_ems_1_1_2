...
public class VESFaultFieldsPOJO {
    ...
    private HashMap<String, String> alarmAdditionalInformation = new HashMap<String, String>();
    ...
    public HashMap<String, String> getAlarmAdditionalInformation() {
        return alarmAdditionalInformation;
    }

    public void setAlarmAdditionalInformation(HashMap<String, String> alarmAdditionalInformation) {
