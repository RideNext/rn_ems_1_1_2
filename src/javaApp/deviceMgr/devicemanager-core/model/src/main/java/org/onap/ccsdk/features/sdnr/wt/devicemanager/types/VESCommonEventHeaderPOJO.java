...
public class VESCommonEventHeaderPOJO {
    ...
    private HashMap<String, String> internalHeaderFields = new HashMap<String, String>();
    ...
    public void setVesEventListenerVersion(String vesEventListenerVersion) {
     ...
     public HashMap<String, String> getInternalHeaderFields() {
        return internalHeaderFields;
    }

    public void setInternalHeaderFields(HashMap<String, String> internalHeaderFields) {
