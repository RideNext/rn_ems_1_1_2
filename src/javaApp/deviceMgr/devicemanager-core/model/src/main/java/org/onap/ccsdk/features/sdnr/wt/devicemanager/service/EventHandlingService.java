...
public interface EventHandlingService {
    ...
    void connectIndication(NodeId nNodeId, String deviceType ,String modelNumber,String softwareVersion ,String serialNumber ,String vendorDetails);

    /**
       *  * @param mountPointNodeName
     * @param isStartUpdone
     */
    void startUpXmlIndication(String nNodeId, String isStartUpdone);
