...
class FileCollectorTest {
    ...
    private Path LOCAL_FILE_LOCATION = appConfigMock.checkfilestore() ? Paths.get(DATAFILE_TMPDIR, SOURCE_NAME, PM_FILE_NAME) 
	: Paths.get(DATAFILE_TMPDIR, PM_FILE_NAME) ;
