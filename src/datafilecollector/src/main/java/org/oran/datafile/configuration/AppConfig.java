...
public class AppConfig {
    ...
    @Value("${app.s3.filestore:}")
    private String fileStore;

    public String getS3LocksBucket() {
        return s3LocksBucket.isEmpty() ? s3Bucket : s3LocksBucket;
    }
    public boolean checkfilestore(){
       System.out.println("checking the filestore");
       System.out.println("checkfilestore enetered"+fileStore.equals("local") );
       return  fileStore.equals("local") ? false : true;
    }
