...
public class FileReadyMessage {
    ...
    public static class MessageMetaData {
	   ...
	   System.out.println("productName entered");
            String[] eventArray = eventName.split("_|-");
           System.out.println("productName entered "+eventArray);
        ...
        public String vendorName() {
           System.out.println("vendorName entered");

            String[] eventArray = eventName.split("_|-");
           System.out.println("vendorName entered "+eventArray);
