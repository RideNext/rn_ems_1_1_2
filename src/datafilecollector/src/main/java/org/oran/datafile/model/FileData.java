...
//    private final AppConfig config;
   ...
   // System.out.println("file store app config "+ config);
    ...
    public String name(AppConfig config) {
	System.out.println("file store name entered");
        System.out.println("file store config.checkfilestore "+ config.checkfilestore());
        System.out.println("file info name "+ fileInfo.name);
        System.out.println("message metadata "+this.messageMetaData.sourceName );
        System.out.println("name method enetered");
        return config.checkfilestore() ? (this.messageMetaData.sourceName + "/" + fileInfo.name) : (fileInfo.name);
    ...
    public Path getLocalFilePath(AppConfig config) {
          System.out.println("file store local path:" + config.checkfilestore());
       return config.checkfilestore() ? Paths.get(config.getCollectedFilesPath(), this.messageMetaData.sourceName, fileInfo.name) : Paths.get(config.getCollectedFilesPath(), fileInfo.name);
